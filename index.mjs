// Banco Central de Nicaragua exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcn';
...
/** Latest rate for one pair, e.g. getRate('USD', 'NIO', { apiKey }). */
